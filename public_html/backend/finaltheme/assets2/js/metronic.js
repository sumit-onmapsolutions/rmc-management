...
var Jarvis = (function() {
  ...
  // runs callback functions set by Jarvis.addResponsiveHandler().
  ...
  var handleScrollers = function() {
    Jarvis.initSlimScroll(".scroller");
  };
  ...
  return {
    ...
    // wrJarviser function to scroll(focus) to an element
    ...
    // wrJarviser function to  block element(indicate loading)
    ...
    // wrJarviser function to  un-block element(finish loading)
    ...
    alert: function(options) {
      ...
      var id = Jarvis.getUniqueID("Jarvis_alert");

      var html =
        '<div id="' +
        id +
        '" class="Jarvis-alerts alert alert-' +
        options.type +
        ' fade in">' +
        (options.close
    ...
    //wrJarviser function to update/sync jquery uniform checkbox & radios
